![GitHub Release](https://img.shields.io/github/v/release/EiS94/db-info-card)
![License](https://img.shields.io/github/license/EiS94/db-info-card)
![Stars](https://img.shields.io/github/stars/EiS94/db-info-card)
![Validate](https://img.shields.io/github/actions/workflow/status/EiS94/db-info-card/validate.yml?label=Validate)
![hacs_badge](https://img.shields.io/badge/HACS-Custom-orange.svg)
![Downloads](https://img.shields.io/github/downloads/EiS94/db-info-card/total)
🚉 DB Info Card
A custom Lovelace card for Home Assistant that displays Deutsche Bahn connections with
...
---
✨ Features
Displays connections of a DB Info entry in a sortable table (1–5 configurable)
...
DB Info Integration installed and configured
---
📥 Installation
Via HACS
...
Manual Installation
Download `db-info-card.js` from the latest release
Copy it to `config/www/db-info-card.js`
...
`max_connections`	`number`	`5`	Number of connections to display (1–5). The integration always fetches 5; this limits how many are shown
`hide_city`	`string`	(none)	Hides the name of the city in the start column, e.g. `Letzter Hieb, Würzburg` transforms to `Letzter Hieb`
---
